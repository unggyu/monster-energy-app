import { DetailsProps, TextContainerProps } from 'monster-energy-app'
import React, { Component } from 'react'
import { Animated, Dimensions, Easing, Image, ImageBackground, StyleSheet, Text, TouchableWithoutFeedback, View } from 'react-native'
...
class TextContainer extends Component<TextContainerProps> {
